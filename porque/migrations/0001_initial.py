# Generated by Django 4.2 on 2024-10-04 15:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Responsable1', models.ManyToManyField(blank=True, null=True, related_name='responsable1', to='porque.miembroequipo')),
                ('Responsable1_2', models.ManyToManyField(blank=True, null=True, related_name='responsable1_2', to='porque.miembroequipo')),
                ('Responsable1_3', models.ManyToManyField(blank=True, null=True, related_name='responsable1_3', to='porque.miembroequipo')),
                ('Responsable1_4', models.ManyToManyField(blank=True, null=True, related_name='responsable1_4', to='porque.miembroequipo')),
                ('Responsable2', models.ManyToManyField(blank=True, null=True, related_name='responsable2', to='porque.miembroequipo')),
                ('Responsable2_2', models.ManyToManyField(blank=True, null=True, related_name='responsable2_2', to='porque.miembroequipo')),
                ('Responsable2_3', models.ManyToManyField(blank=True, null=True, related_name='responsable2_3', to='porque.miembroequipo')),
                ('Responsable2_4', models.ManyToManyField(blank=True, null=True, related_name='responsable2_4', to='porque.miembroequipo')),
