    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('que_ocurre', models.TextField(blank=True, null=True, verbose_name='Qué ocurre? ¿En qué parte de la máquina o materal se visualiza el problema?')),
                ...
                ('cuando_ocurre', models.TextField(blank=True, null=True, verbose_name='¿Cuando ocurrió? Producción, arranque, saneado, cambio de formato, mantención, etc.')),
