...
class Orr(models.Model):
    # Campos existentes
    Nombre_ORR = models.TextField(max_length=100, blank=True, null=True)
...
class ImagenDeploy(models.Model):
    orr = models.ForeignKey(Orr, related_name='imagenes_deploy', on_delete=models.CASCADE)
    imagen = models.ImageField(upload_to='imagenes_deploy/')
    
    def __str__(self):
        return f"Imagen Deploy para {self.orr}"
    
class ImagenDescripcion(models.Model):
    orr = models.ForeignKey(Orr, related_name='imagenes_descripcion', on_delete=models.CASCADE)
    imagen = models.ImageField(upload_to='imagenes_descripcion/')
    
    def __str__(self):
        return f"Imagen Descripcion para {self.orr}"
    
class ImagenDefinir(models.Model):
    orr = models.ForeignKey(Orr, related_name='imagenes_definir', on_delete=models.CASCADE)
    imagen = models.ImageField(upload_to='imagenes_definir/')
    
    def __str__(self):
        return f"Imagen Definir para {self.orr}"

class ImagenEstandar(models.Model):
    orr = models.ForeignKey(Orr, related_name='imagenes_estandar', on_delete=models.CASCADE)
    imagen = models.ImageField(upload_to='imagenes_estandar/')
    
    def __str__(self):
        return f"Imagen Estandar para {self.orr}"
    
class ImagenExpansion(models.Model):
    orr = models.ForeignKey(Orr, related_name='imagenes_expansion', on_delete=models.CASCADE)
    imagen = models.ImageField(upload_to='imagenes_expansion/')
    
    def __str__(self):
        return f"Imagen Expansion para {self.orr}"
