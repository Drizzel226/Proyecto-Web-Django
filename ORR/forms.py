...
from .models import Orr, MiembroEquipo

class OrrForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = [
            # Paso 0
            'Nombre_ORR', 'ahorro', 'categoria', 'subcategoria', 'area', 'subarea', 'maquina', 'miembros_equipo',
            ...
            # Campos replicados con sufijos del _2 al _10
            'accion_2', 'accion_3', 'accion_4', 'accion_5', 'accion_6', 'accion_7', 'accion_8', 'accion_9', 'accion_10',
            'observacion_2', 'observacion_3', 'observacion_4', 'observacion_5', 'observacion_6', 'observacion_7', 'observacion_8', 'observacion_9', 'observacion_10',
            'Respon_2', 'Respon_3', 'Respon_4', 'Respon_5', 'Respon_6', 'Respon_7', 'Respon_8', 'Respon_9', 'Respon_10',
            'opciones_acciones_2', 'opciones_acciones_3', 'opciones_acciones_4', 'opciones_acciones_5', 'opciones_acciones_6', 'opciones_acciones_7', 'opciones_acciones_8', 'opciones_acciones_9', 'opciones_acciones_10',
            'ISHIKAWA_acciones_2', 'ISHIKAWA_acciones_3', 'ISHIKAWA_acciones_4', 'ISHIKAWA_acciones_5', 'ISHIKAWA_acciones_6', 'ISHIKAWA_acciones_7', 'ISHIKAWA_acciones_8', 'ISHIKAWA_acciones_9', 'ISHIKAWA_acciones_10',
            'FechaInicio_acciones_2', 'FechaInicio_acciones_3', 'FechaInicio_acciones_4', 'FechaInicio_acciones_5', 'FechaInicio_acciones_6', 'FechaInicio_acciones_7', 'FechaInicio_acciones_8', 'FechaInicio_acciones_9', 'FechaInicio_acciones_10',
            'FechaCompr_2', 'FechaCompr_3', 'FechaCompr_4', 'FechaCompr_5', 'FechaCompr_6', 'FechaCompr_7', 'FechaCompr_8', 'FechaCompr_9', 'FechaCompr_10',
            'FechaCierre_acciones_2', 'FechaCierre_acciones_3', 'FechaCierre_acciones_4', 'FechaCierre_acciones_5', 'FechaCierre_acciones_6', 'FechaCierre_acciones_7', 'FechaCierre_acciones_8', 'FechaCierre_acciones_9', 'FechaCierre_acciones_10',
            'estado_accion_2', 'estado_accion_3', 'estado_accion_4', 'estado_accion_5', 'estado_accion_6', 'estado_accion_7', 'estado_accion_8', 'estado_accion_9', 'estado_accion_10',
        ...
        widgets = {
            ...
            'accion_2': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_3': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_4': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_5': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_6': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_7': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_8': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_9': forms.Textarea(attrs={'class': 'form-control'}),
            'accion_10': forms.Textarea(attrs={'class': 'form-control'}),

            'observacion_2': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_3': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_4': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_5': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_6': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_7': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_8': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_9': forms.Textarea(attrs={'class': 'form-control'}),
            'observacion_10': forms.Textarea(attrs={'class': 'form-control'}),

            'opciones_acciones_2': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_3': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_4': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_5': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_6': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_7': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_8': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_9': forms.Select(attrs={'class': 'form-control'}),
            'opciones_acciones_10': forms.Select(attrs={'class': 'form-control'}),

            'ISHIKAWA_acciones_2': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_3': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_4': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_5': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_6': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_7': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_8': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_9': forms.Select(attrs={'class': 'form-control'}),
            'ISHIKAWA_acciones_10': forms.Select(attrs={'class': 'form-control'}),

            'FechaInicio_acciones_2': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_3': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_4': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_5': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_6': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_7': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_8': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_9': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaInicio_acciones_10': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),

            'FechaCompr_2': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_3': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_4': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_5': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_6': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_7': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_8': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_9': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCompr_10': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),

            'FechaCierre_acciones_2': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_3': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_4': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_5': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_6': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_7': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_8': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_9': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
            'FechaCierre_acciones_10': forms.DateInput(attrs={'class': 'form-control', 'type': 'date'}),
    ...
    def __init__(self, *args, **kwargs):
        super(OrrForm, self).__init__(*args, **kwargs)
